...
using Assets.Classes.Foundation.Interfaces;
using UnityEngine;

namespace Assets.Classes.Foundation.Classes
{
    [StructLayout(LayoutKind.Sequential)]
    public struct RectI : ISizeInBytes
    {
        private int _minX;
        private int _maxY;
        private int _width;
        ...
        public RectI(Point2 center, int width, int height)
        {
        ...
        public static RectI MinMaxRect(int left, int top, int right, int bottom)
        {
        ...
        public static implicit operator Bounds(RectI r)
        {
